...
80100044:	bb 14 b7 10 80       	mov    $0x8010b714,%ebx
{
80100049:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
8010004c:	68 20 70 10 80       	push   $0x80107020
80100051:	68 e0 b6 10 80       	push   $0x8010b6e0
80100056:	e8 a5 41 00 00       	call   80104200 <initlock>
  bcache.head.prev = &bcache.head;
8010005b:	c7 05 2c fe 10 80 dc 	movl   $0x8010fddc,0x8010fe2c
80100062:	fd 10 80 
  bcache.head.next = &bcache.head;
80100065:	c7 05 30 fe 10 80 dc 	movl   $0x8010fddc,0x8010fe30
8010006c:	fd 10 80 
8010006f:	83 c4 10             	add    $0x10,%esp
80100072:	ba dc fd 10 80       	mov    $0x8010fddc,%edx
...
801000aa:	8d 83 5c 02 00 00    	lea    0x25c(%ebx),%eax
    bcache.head.next = b;
801000b0:	89 1d 30 fe 10 80    	mov    %ebx,0x8010fe30
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	3d dc fd 10 80       	cmp    $0x8010fddc,%eax
...
801000dc:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000df:	68 e0 b6 10 80       	push   $0x8010b6e0
801000e4:	e8 57 42 00 00       	call   80104340 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000e9:	8b 1d 30 fe 10 80    	mov    0x8010fe30,%ebx
801000ef:	83 c4 10             	add    $0x10,%esp
801000f2:	81 fb dc fd 10 80    	cmp    $0x8010fddc,%ebx
801000f8:	75 11                	jne    8010010b <bread+0x3b>
801000fa:	eb 24                	jmp    80100120 <bread+0x50>
801000fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80100100:	8b 5b 54             	mov    0x54(%ebx),%ebx
80100103:	81 fb dc fd 10 80    	cmp    $0x8010fddc,%ebx
...
80100120:	8b 1d 2c fe 10 80    	mov    0x8010fe2c,%ebx
80100126:	81 fb dc fd 10 80    	cmp    $0x8010fddc,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x6b>
8010012e:	eb 60                	jmp    80100190 <bread+0xc0>
80100130:	8b 5b 50             	mov    0x50(%ebx),%ebx
80100133:	81 fb dc fd 10 80    	cmp    $0x8010fddc,%ebx
...
8010015d:	68 e0 b6 10 80       	push   $0x8010b6e0
...
801001ff:	e8 6c 3f 00 00       	call   80104170 <releasesleep>
  ...
  acquire(&bcache.lock);
80100204:	c7 04 24 e0 b6 10 80 	movl   $0x8010b6e0,(%esp)
...
8010022f:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100232:	a1 30 fe 10 80       	mov    0x8010fe30,%eax
    b->prev = &bcache.head;
80100237:	c7 43 50 dc fd 10 80 	movl   $0x8010fddc,0x50(%ebx)
    b->next = bcache.head.next;
8010023e:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100241:	a1 30 fe 10 80       	mov    0x8010fe30,%eax
80100246:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100249:	89 1d 30 fe 10 80    	mov    %ebx,0x8010fe30
  }
  
  release(&bcache.lock);
8010024f:	c7 45 08 e0 b6 10 80 	movl   $0x8010b6e0,0x8(%ebp)
}
...
801002a1:	8b 15 c0 00 11 80    	mov    0x801100c0,%edx
801002a7:	39 15 c4 00 11 80    	cmp    %edx,0x801100c4
...
801002c5:	e8 b6 3a 00 00       	call   80103d80 <sleep>
    while(input.r == input.w){
801002ca:	8b 15 c0 00 11 80    	mov    0x801100c0,%edx
801002d0:	83 c4 10             	add    $0x10,%esp
801002d3:	3b 15 c4 00 11 80    	cmp    0x801100c4,%edx
...
80100313:	a3 c0 00 11 80       	mov    %eax,0x801100c0
80100318:	89 d0                	mov    %edx,%eax
8010031a:	83 e0 7f             	and    $0x7f,%eax
8010031d:	0f be 80 40 00 11 80 	movsbl -0x7feeffc0(%eax),%eax
    if(c == C('D')){  // EOF
...
80100370:	73 d0                	jae    80100342 <consoleread+0xd2>
        input.r--;
80100372:	89 15 c0 00 11 80    	mov    %edx,0x801100c0
...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 bb 79 10 80 	movl   $0x801079bb,(%esp)
...
8010043a:	e8 e1 57 00 00       	call   80105c20 <uartputc>
...
801004ec:	e8 2f 57 00 00       	call   80105c20 <uartputc>
801004f1:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f8:	e8 23 57 00 00       	call   80105c20 <uartputc>
801004fd:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100504:	e8 17 57 00 00       	call   80105c20 <uartputc>
...
80100551:	68 65 70 10 80       	push   $0x80107065
...
801007cf:	90                   	nop
        s = "(null)";
801007d0:	ba 78 70 10 80       	mov    $0x80107078,%edx
      for(; *s; s++)
...
80100800:	68 7f 70 10 80       	push   $0x8010707f
...
8010084f:	75 54                	jne    801008a5 <consoleintr+0x95>
      if(input.e != input.w){
80100851:	a1 c8 00 11 80       	mov    0x801100c8,%eax
80100856:	3b 05 c4 00 11 80    	cmp    0x801100c4,%eax
8010085c:	74 d2                	je     80100830 <consoleintr+0x20>
        input.e--;
8010085e:	83 e8 01             	sub    $0x1,%eax
80100861:	a3 c8 00 11 80       	mov    %eax,0x801100c8
        consputc(BACKSPACE);
...
801008a9:	a1 c8 00 11 80       	mov    0x801100c8,%eax
801008ae:	89 c2                	mov    %eax,%edx
801008b0:	2b 15 c0 00 11 80    	sub    0x801100c0,%edx
...
801008c8:	89 15 c8 00 11 80    	mov    %edx,0x801100c8
        c = (c == '\r') ? '\n' : c;
801008ce:	0f 84 cc 00 00 00    	je     801009a0 <consoleintr+0x190>
        input.buf[input.e++ % INPUT_BUF] = c;
801008d4:	89 f9                	mov    %edi,%ecx
801008d6:	88 88 40 00 11 80    	mov    %cl,-0x7feeffc0(%eax)
        consputc(c);
...
801008f5:	a1 c0 00 11 80       	mov    0x801100c0,%eax
801008fa:	83 e8 80             	sub    $0xffffff80,%eax
801008fd:	39 05 c8 00 11 80    	cmp    %eax,0x801100c8
80100903:	0f 85 27 ff ff ff    	jne    80100830 <consoleintr+0x20>
          wakeup(&input.r);
80100909:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
8010090c:	a3 c4 00 11 80       	mov    %eax,0x801100c4
          wakeup(&input.r);
80100911:	68 c0 00 11 80       	push   $0x801100c0
...
80100938:	a1 c8 00 11 80       	mov    0x801100c8,%eax
8010093d:	39 05 c4 00 11 80    	cmp    %eax,0x801100c4
80100943:	75 2b                	jne    80100970 <consoleintr+0x160>
80100945:	e9 e6 fe ff ff       	jmp    80100830 <consoleintr+0x20>
8010094a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        input.e--;
80100950:	a3 c8 00 11 80       	mov    %eax,0x801100c8
        consputc(BACKSPACE);
80100955:	b8 00 01 00 00       	mov    $0x100,%eax
8010095a:	e8 b1 fa ff ff       	call   80100410 <consputc>
      while(input.e != input.w &&
8010095f:	a1 c8 00 11 80       	mov    0x801100c8,%eax
80100964:	3b 05 c4 00 11 80    	cmp    0x801100c4,%eax
...
80100975:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100978:	80 ba 40 00 11 80 0a 	cmpb   $0xa,-0x7feeffc0(%edx)
...
8010099c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        input.buf[input.e++ % INPUT_BUF] = c;
801009a0:	c6 80 40 00 11 80 0a 	movb   $0xa,-0x7feeffc0(%eax)
        consputc(c);
801009a7:	b8 0a 00 00 00       	mov    $0xa,%eax
801009ac:	e8 5f fa ff ff       	call   80100410 <consputc>
801009b1:	a1 c8 00 11 80       	mov    0x801100c8,%eax
...
801009c6:	68 88 70 10 80       	push   $0x80107088
...
801009d9:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
801009db:	c7 05 8c 0a 11 80 00 	movl   $0x80100600,0x80110a8c
801009e2:	06 10 80 
  devsw[CONSOLE].read = consoleread;
801009e5:	c7 05 88 0a 11 80 70 	movl   $0x80100270,0x80110a88
801009ec:	02 10 80 
  cons.locking = 1;
...
80100a92:	75 d2                	jne    80100a66 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a94:	e8 d7 62 00 00       	call   80106d70 <setupkvm>
...
80100af6:	e8 95 60 00 00       	call   80106b90 <allocuvm>
...
80100b28:	e8 a3 5f 00 00       	call   80106ad0 <loaduvm>
...
80100b72:	e8 79 61 00 00       	call   80106cf0 <freevm>
...
80100baa:	e8 e1 5f 00 00       	call   80106b90 <allocuvm>
...
80100bc1:	e8 2a 61 00 00       	call   80106cf0 <freevm>
...
80100bdb:	68 a1 70 10 80       	push   $0x801070a1
...
80100c06:	e8 05 62 00 00       	call   80106e10 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c5d:	e8 0e 63 00 00       	call   80106f70 <copyout>
...
80100d3c:	e8 af 5f 00 00       	call   80106cf0 <freevm>
  return 0;
...
80100d66:	68 ad 70 10 80       	push   $0x801070ad
80100d6b:	68 e0 00 11 80       	push   $0x801100e0
...
80100d84:	bb 14 01 11 80       	mov    $0x80110114,%ebx
{
80100d89:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100d8c:	68 e0 00 11 80       	push   $0x801100e0
...
80100da3:	81 fb 74 0a 11 80    	cmp    $0x80110a74,%ebx
...
80100db5:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100dbc:	68 e0 00 11 80       	push   $0x801100e0
...
80100dd3:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100dd5:	68 e0 00 11 80       	push   $0x801100e0
...
80100df7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dfa:	68 e0 00 11 80       	push   $0x801100e0
...
80100e14:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e17:	68 e0 00 11 80       	push   $0x801100e0
...
80100e2b:	68 b4 70 10 80       	push   $0x801070b4
...
80100e49:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100e4c:	68 e0 00 11 80       	push   $0x801100e0
...
80100e6c:	74 1a                	je     80100e88 <fileclose+0x48>
    release(&ftable.lock);
80100e6e:	c7 45 08 e0 00 11 80 	movl   $0x801100e0,0x8(%ebp)
...
80100e9d:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100ea0:	68 e0 00 11 80       	push   $0x801100e0
  ff = *f;
...
80100f02:	68 bc 70 10 80       	push   $0x801070bc
...
80100fe2:	68 c6 70 10 80       	push   $0x801070c6
...
801010f5:	68 cf 70 10 80       	push   $0x801070cf
801010fa:	e8 91 f2 ff ff       	call   80100390 <panic>
  panic("filewrite");
801010ff:	83 ec 0c             	sub    $0xc,%esp
80101102:	68 d5 70 10 80       	push   $0x801070d5
...
8010111a:	03 15 f8 0a 11 80    	add    0x80110af8,%edx
...
80101173:	68 df 70 10 80       	push   $0x801070df
...
80101189:	8b 0d e0 0a 11 80    	mov    0x80110ae0,%ecx
{
...
801011ac:	03 05 f8 0a 11 80    	add    0x80110af8,%eax
801011b2:	50                   	push   %eax
801011b3:	ff 75 d8             	pushl  -0x28(%ebp)
801011b6:	e8 15 ef ff ff       	call   801000d0 <bread>
801011bb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
801011be:	a1 e0 0a 11 80       	mov    0x80110ae0,%eax
...
80101219:	39 05 e0 0a 11 80    	cmp    %eax,0x80110ae0
8010121f:	77 80                	ja     801011a1 <balloc+0x21>
  panic("balloc: out of blocks");
80101221:	83 ec 0c             	sub    $0xc,%esp
80101224:	68 f2 70 10 80       	push   $0x801070f2
...
8010129a:	bb 34 0b 11 80       	mov    $0x80110b34,%ebx
{
8010129f:	83 ec 28             	sub    $0x28,%esp
801012a2:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012a5:	68 00 0b 11 80       	push   $0x80110b00
...
801012c6:	81 fb 54 27 11 80    	cmp    $0x80112754,%ebx
...
801012e8:	81 fb 54 27 11 80    	cmp    $0x80112754,%ebx
...
80101303:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
8010130a:	68 00 0b 11 80       	push   $0x80110b00
...
80101333:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
80101335:	68 00 0b 11 80       	push   $0x80110b00
      ip->ref++;
...
80101352:	68 08 71 10 80       	push   $0x80107108
...
80101427:	68 18 71 10 80       	push   $0x80107118
...
80101484:	bb 40 0b 11 80       	mov    $0x80110b40,%ebx
80101489:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010148c:	68 2b 71 10 80       	push   $0x8010712b
80101491:	68 00 0b 11 80       	push   $0x80110b00
80101496:	e8 65 2d 00 00       	call   80104200 <initlock>
8010149b:	83 c4 10             	add    $0x10,%esp
8010149e:	66 90                	xchg   %ax,%ax
    initsleeplock(&icache.inode[i].lock, "inode");
801014a0:	83 ec 08             	sub    $0x8,%esp
801014a3:	68 32 71 10 80       	push   $0x80107132
801014a8:	53                   	push   %ebx
801014a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
801014af:	e8 1c 2c 00 00       	call   801040d0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
801014b4:	83 c4 10             	add    $0x10,%esp
801014b7:	81 fb 60 27 11 80    	cmp    $0x80112760,%ebx
801014bd:	75 e1                	jne    801014a0 <iinit+0x20>
  readsb(dev, &sb);
801014bf:	83 ec 08             	sub    $0x8,%esp
801014c2:	68 e0 0a 11 80       	push   $0x80110ae0
801014c7:	ff 75 08             	pushl  0x8(%ebp)
801014ca:	e8 71 ff ff ff       	call   80101440 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014cf:	ff 35 f8 0a 11 80    	pushl  0x80110af8
801014d5:	ff 35 f4 0a 11 80    	pushl  0x80110af4
801014db:	ff 35 f0 0a 11 80    	pushl  0x80110af0
801014e1:	ff 35 ec 0a 11 80    	pushl  0x80110aec
801014e7:	ff 35 e8 0a 11 80    	pushl  0x80110ae8
801014ed:	ff 35 e4 0a 11 80    	pushl  0x80110ae4
801014f3:	ff 35 e0 0a 11 80    	pushl  0x80110ae0
...
80101519:	83 3d e8 0a 11 80 01 	cmpl   $0x1,0x80110ae8
{
...
8010154f:	39 1d e8 0a 11 80    	cmp    %ebx,0x80110ae8
80101555:	76 69                	jbe    801015c0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101557:	89 d8                	mov    %ebx,%eax
80101559:	83 ec 08             	sub    $0x8,%esp
8010155c:	c1 e8 03             	shr    $0x3,%eax
8010155f:	03 05 f4 0a 11 80    	add    0x80110af4,%eax
...
801015c3:	68 38 71 10 80       	push   $0x80107138
...
801015e4:	03 05 f4 0a 11 80    	add    0x80110af4,%eax
...
80101657:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010165a:	68 00 0b 11 80       	push   $0x80110b00
8010165f:	e8 dc 2c 00 00       	call   80104340 <acquire>
  ip->ref++;
80101664:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101668:	c7 04 24 00 0b 11 80 	movl   $0x80110b00,(%esp)
...
801016c9:	03 05 f4 0a 11 80    	add    0x80110af4,%eax
...
8010173d:	68 50 71 10 80       	push   $0x80107150
80101742:	e8 49 ec ff ff       	call   80100390 <panic>
    panic("ilock");
80101747:	83 ec 0c             	sub    $0xc,%esp
8010174a:	68 4a 71 10 80       	push   $0x8010714a
...
80101797:	68 5f 71 10 80       	push   $0x8010715f
...
801017da:	e8 91 29 00 00       	call   80104170 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 00 0b 11 80 	movl   $0x80110b00,(%esp)
801017e6:	e8 55 2b 00 00       	call   80104340 <acquire>
  ip->ref--;
801017eb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801017ef:	83 c4 10             	add    $0x10,%esp
801017f2:	c7 45 08 00 0b 11 80 	movl   $0x80110b00,0x8(%ebp)
}
...
8010180b:	68 00 0b 11 80       	push   $0x80110b00
80101810:	e8 2b 2b 00 00       	call   80104340 <acquire>
    int r = ip->ref;
80101815:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101818:	c7 04 24 00 0b 11 80 	movl   $0x80110b00,(%esp)
...
80101a3a:	8b 04 c5 80 0a 11 80 	mov    -0x7feef580(,%eax,8),%eax
...
80101b4a:	8b 04 c5 84 0a 11 80 	mov    -0x7feef57c(,%eax,8),%eax
...
80101c42:	68 79 71 10 80       	push   $0x80107179
80101c47:	e8 44 e7 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101c4c:	83 ec 0c             	sub    $0xc,%esp
80101c4f:	68 67 71 10 80       	push   $0x80107167
...
80101c81:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101c84:	68 00 0b 11 80       	push   $0x80110b00
80101c89:	e8 b2 26 00 00       	call   80104340 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 00 0b 11 80 	movl   $0x80110b00,(%esp)
...
80101ebb:	68 88 71 10 80       	push   $0x80107188
...
80101fdb:	68 f4 71 10 80       	push   $0x801071f4
80101fe0:	e8 ab e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80101fe5:	83 ec 0c             	sub    $0xc,%esp
80101fe8:	68 eb 71 10 80       	push   $0x801071eb
...
801021fa:	68 20 72 10 80       	push   $0x80107220
801021ff:	e8 8c e1 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102204:	83 ec 0c             	sub    $0xc,%esp
80102207:	68 0a 72 10 80       	push   $0x8010720a
8010220c:	e8 7f e1 ff ff       	call   80100390 <panic>
    panic("iderw: ide disk 1 not present");
80102211:	83 ec 0c             	sub    $0xc,%esp
80102214:	68 35 72 10 80       	push   $0x80107235
...
80102221:	c7 05 54 27 11 80 00 	movl   $0xfec00000,0x80112754
80102228:	00 c0 fe 
{
...
80102236:	00 00 00 
  return ioapic->data;
80102239:	a1 54 27 11 80       	mov    0x80112754,%eax
8010223e:	8b 58 10             	mov    0x10(%eax),%ebx
  ioapic->reg = reg;
80102241:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return ioapic->data;
80102247:	8b 0d 54 27 11 80    	mov    0x80112754,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
8010224d:	0f b6 15 80 28 11 80 	movzbl 0x80112880,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
80102267:	68 54 72 10 80       	push   $0x80107254
8010226c:	e8 ef e3 ff ff       	call   80100660 <cprintf>
80102271:	8b 0d 54 27 11 80    	mov    0x80112754,%ecx
...
80102290:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
80102292:	8b 0d 54 27 11 80    	mov    0x80112754,%ecx
...
801022ae:	89 31                	mov    %esi,(%ecx)
  ioapic->data = data;
801022b0:	8b 0d 54 27 11 80    	mov    0x80112754,%ecx
...
801022d0:	55                   	push   %ebp
  ioapic->reg = reg;
801022d1:	8b 0d 54 27 11 80    	mov    0x80112754,%ecx
{
...
801022e3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022e5:	8b 0d 54 27 11 80    	mov    0x80112754,%ecx
...
801022f4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022f6:	a1 54 27 11 80       	mov    0x80112754,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102342:	e8 09 21 00 00       	call   80104450 <memset>
  ...
  if(kmem.use_lock)
80102347:	8b 15 94 27 11 80    	mov    0x80112794,%edx
...
80102354:	a1 98 27 11 80       	mov    0x80112798,%eax
80102359:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010235b:	a1 94 27 11 80       	mov    0x80112794,%eax
  kmem.freelist = r;
80102360:	89 1d 98 27 11 80    	mov    %ebx,0x80112798
  if(kmem.use_lock)
...
8010236f:	90                   	nop
    release(&kmem.lock);
80102370:	c7 45 08 60 27 11 80 	movl   $0x80112760,0x8(%ebp)
}
...
80102383:	68 60 27 11 80       	push   $0x80112760
80102388:	e8 b3 1f 00 00       	call   80104340 <acquire>
8010238d:	83 c4 10             	add    $0x10,%esp
80102390:	eb c2                	jmp    80102354 <kfree+0x44>
    panic("kfree");
80102392:	83 ec 0c             	sub    $0xc,%esp
80102395:	68 86 72 10 80       	push   $0x80107286
...
801023fb:	68 8c 72 10 80       	push   $0x8010728c
80102400:	68 60 27 11 80       	push   $0x80112760
...
8010240d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102410:	c7 05 94 27 11 80 00 	movl   $0x0,0x80112794
80102417:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
801024a2:	73 e4                	jae    80102488 <kinit2+0x28>
  kmem.use_lock = 1;
801024a4:	c7 05 94 27 11 80 01 	movl   $0x1,0x80112794
801024ab:	00 00 00 
}
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
801024c0:	a1 94 27 11 80       	mov    0x80112794,%eax
801024c5:	85 c0                	test   %eax,%eax
801024c7:	75 1f                	jne    801024e8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
801024c9:	a1 98 27 11 80       	mov    0x80112798,%eax
  if(r)
801024ce:	85 c0                	test   %eax,%eax
801024d0:	74 0e                	je     801024e0 <kalloc+0x20>
    kmem.freelist = r->next;
801024d2:	8b 10                	mov    (%eax),%edx
801024d4:	89 15 98 27 11 80    	mov    %edx,0x80112798
801024da:	c3                   	ret    
801024db:	90                   	nop
...
801024eb:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801024ee:	68 60 27 11 80       	push   $0x80112760
801024f3:	e8 48 1e 00 00       	call   80104340 <acquire>
  r = kmem.freelist;
801024f8:	a1 98 27 11 80       	mov    0x80112798,%eax
  if(r)
801024fd:	83 c4 10             	add    $0x10,%esp
80102500:	8b 15 94 27 11 80    	mov    0x80112794,%edx
80102506:	85 c0                	test   %eax,%eax
80102508:	74 08                	je     80102512 <kalloc+0x52>
    kmem.freelist = r->next;
8010250a:	8b 08                	mov    (%eax),%ecx
8010250c:	89 0d 98 27 11 80    	mov    %ecx,0x80112798
  if(kmem.use_lock)
...
8010251c:	68 60 27 11 80       	push   $0x80112760
...
80102573:	0f b6 82 c0 73 10 80 	movzbl -0x7fef8c40(%edx),%eax
8010257a:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
8010257c:	0f b6 82 c0 72 10 80 	movzbl -0x7fef8d40(%edx),%eax
...
80102590:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
80102593:	8b 04 85 a0 72 10 80 	mov    -0x7fef8d60(,%eax,4),%eax
...
801025b5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025b8:	0f b6 82 c0 73 10 80 	movzbl -0x7fef8c40(%edx),%eax
...
{
  if(!lapic)
80102630:	a1 9c 27 11 80       	mov    0x8011279c,%eax
{
...
{
  if (!lapic)
80102730:	8b 15 9c 27 11 80    	mov    0x8011279c,%edx
{
...
{
  if(lapic)
80102750:	a1 9c 27 11 80       	mov    0x8011279c,%eax
{
...
801027b8:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
801027be:	a1 9c 27 11 80       	mov    0x8011279c,%eax
...
80102a00:	8b 0d e8 27 11 80    	mov    0x801127e8,%ecx
...
80102a20:	a1 d4 27 11 80       	mov    0x801127d4,%eax
80102a25:	83 ec 08             	sub    $0x8,%esp
80102a28:	01 d8                	add    %ebx,%eax
80102a2a:	83 c0 01             	add    $0x1,%eax
80102a2d:	50                   	push   %eax
80102a2e:	ff 35 e4 27 11 80    	pushl  0x801127e4
80102a34:	e8 97 d6 ff ff       	call   801000d0 <bread>
80102a39:	89 c7                	mov    %eax,%edi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102a3b:	58                   	pop    %eax
80102a3c:	5a                   	pop    %edx
80102a3d:	ff 34 9d ec 27 11 80 	pushl  -0x7feed814(,%ebx,4)
80102a44:	ff 35 e4 27 11 80    	pushl  0x801127e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102a84:	39 1d e8 27 11 80    	cmp    %ebx,0x801127e8
...
80102aa8:	ff 35 d4 27 11 80    	pushl  0x801127d4
80102aae:	ff 35 e4 27 11 80    	pushl  0x801127e4
80102ab4:	e8 17 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102ab9:	8b 1d e8 27 11 80    	mov    0x801127e8,%ebx
...
80102ad0:	8b 8a ec 27 11 80    	mov    -0x7feed814(%edx),%ecx
...
80102b0a:	68 c0 74 10 80       	push   $0x801074c0
80102b0f:	68 a0 27 11 80       	push   $0x801127a0
...
80102b2b:	59                   	pop    %ecx
  log.dev = dev;
80102b2c:	89 1d e4 27 11 80    	mov    %ebx,0x801127e4
  log.size = sb.nlog;
80102b32:	89 15 d8 27 11 80    	mov    %edx,0x801127d8
  log.start = sb.logstart;
80102b38:	a3 d4 27 11 80       	mov    %eax,0x801127d4
  struct buf *buf = bread(log.dev, log.start);
80102b3d:	5a                   	pop    %edx
...
80102b4b:	85 db                	test   %ebx,%ebx
  log.lh.n = lh->n;
80102b4d:	89 1d e8 27 11 80    	mov    %ebx,0x801127e8
  for (i = 0; i < log.lh.n; i++) {
...
80102b67:	89 8a e8 27 11 80    	mov    %ecx,-0x7feed818(%edx)
  for (i = 0; i < log.lh.n; i++) {
...
80102b7a:	e8 81 fe ff ff       	call   80102a00 <install_trans>
  log.lh.n = 0;
80102b7f:	c7 05 e8 27 11 80 00 	movl   $0x0,0x801127e8
80102b86:	00 00 00 
...
80102ba3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102ba6:	68 a0 27 11 80       	push   $0x801127a0
...
80102bbb:	68 a0 27 11 80       	push   $0x801127a0
80102bc0:	68 a0 27 11 80       	push   $0x801127a0
80102bc5:	e8 b6 11 00 00       	call   80103d80 <sleep>
80102bca:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102bcd:	a1 e0 27 11 80       	mov    0x801127e0,%eax
80102bd2:	85 c0                	test   %eax,%eax
80102bd4:	75 e2                	jne    80102bb8 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102bd6:	a1 dc 27 11 80       	mov    0x801127dc,%eax
80102bdb:	8b 15 e8 27 11 80    	mov    0x801127e8,%edx
...
80102bef:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102bf2:	a3 dc 27 11 80       	mov    %eax,0x801127dc
      release(&log.lock);
80102bf7:	68 a0 27 11 80       	push   $0x801127a0
...
80102c16:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102c19:	68 a0 27 11 80       	push   $0x801127a0
80102c1e:	e8 1d 17 00 00       	call   80104340 <acquire>
  log.outstanding -= 1;
80102c23:	a1 dc 27 11 80       	mov    0x801127dc,%eax
  if(log.committing)
80102c28:	8b 35 e0 27 11 80    	mov    0x801127e0,%esi
...
80102c34:	85 f6                	test   %esi,%esi
  log.outstanding -= 1;
80102c36:	89 1d dc 27 11 80    	mov    %ebx,0x801127dc
  if(log.committing)
...
80102c4a:	83 ec 0c             	sub    $0xc,%esp
    log.committing = 1;
80102c4d:	c7 05 e0 27 11 80 01 	movl   $0x1,0x801127e0
80102c54:	00 00 00 
  release(&log.lock);
80102c57:	68 a0 27 11 80       	push   $0x801127a0
...
{
  if (log.lh.n > 0) {
80102c61:	8b 0d e8 27 11 80    	mov    0x801127e8,%ecx
80102c67:	83 c4 10             	add    $0x10,%esp
80102c6a:	85 c9                	test   %ecx,%ecx
80102c6c:	0f 8e 85 00 00 00    	jle    80102cf7 <end_op+0xe7>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
80102c72:	a1 d4 27 11 80       	mov    0x801127d4,%eax
80102c77:	83 ec 08             	sub    $0x8,%esp
80102c7a:	01 d8                	add    %ebx,%eax
80102c7c:	83 c0 01             	add    $0x1,%eax
80102c7f:	50                   	push   %eax
80102c80:	ff 35 e4 27 11 80    	pushl  0x801127e4
80102c86:	e8 45 d4 ff ff       	call   801000d0 <bread>
80102c8b:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c8d:	58                   	pop    %eax
80102c8e:	5a                   	pop    %edx
80102c8f:	ff 34 9d ec 27 11 80 	pushl  -0x7feed814(,%ebx,4)
80102c96:	ff 35 e4 27 11 80    	pushl  0x801127e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102cd6:	3b 1d e8 27 11 80    	cmp    0x801127e8,%ebx
...
80102ce3:	e8 18 fd ff ff       	call   80102a00 <install_trans>
    log.lh.n = 0;
80102ce8:	c7 05 e8 27 11 80 00 	movl   $0x0,0x801127e8
80102cef:	00 00 00 
    write_head();    // Erase the transaction from the log
80102cf2:	e8 a9 fd ff ff       	call   80102aa0 <write_head>
    acquire(&log.lock);
80102cf7:	83 ec 0c             	sub    $0xc,%esp
80102cfa:	68 a0 27 11 80       	push   $0x801127a0
80102cff:	e8 3c 16 00 00       	call   80104340 <acquire>
    wakeup(&log);
80102d04:	c7 04 24 a0 27 11 80 	movl   $0x801127a0,(%esp)
    log.committing = 0;
80102d0b:	c7 05 e0 27 11 80 00 	movl   $0x0,0x801127e0
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 16 12 00 00       	call   80103f30 <wakeup>
    release(&log.lock);
80102d1a:	c7 04 24 a0 27 11 80 	movl   $0x801127a0,(%esp)
...
80102d3b:	68 a0 27 11 80       	push   $0x801127a0
80102d40:	e8 eb 11 00 00       	call   80103f30 <wakeup>
  release(&log.lock);
80102d45:	c7 04 24 a0 27 11 80 	movl   $0x801127a0,(%esp)
...
80102d5f:	68 c4 74 10 80       	push   $0x801074c4
...
80102d77:	8b 15 e8 27 11 80    	mov    0x801127e8,%edx
{
80102d7d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102d80:	83 fa 1d             	cmp    $0x1d,%edx
80102d83:	0f 8f 9d 00 00 00    	jg     80102e26 <log_write+0xb6>
80102d89:	a1 d8 27 11 80       	mov    0x801127d8,%eax
80102d8e:	83 e8 01             	sub    $0x1,%eax
80102d91:	39 c2                	cmp    %eax,%edx
80102d93:	0f 8d 8d 00 00 00    	jge    80102e26 <log_write+0xb6>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102d99:	a1 dc 27 11 80       	mov    0x801127dc,%eax
...
80102da9:	68 a0 27 11 80       	push   $0x801127a0
80102dae:	e8 8d 15 00 00       	call   80104340 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102db3:	8b 0d e8 27 11 80    	mov    0x801127e8,%ecx
...
80102dc4:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102dc6:	3b 15 ec 27 11 80    	cmp    0x801127ec,%edx
80102dcc:	75 0b                	jne    80102dd9 <log_write+0x69>
80102dce:	eb 38                	jmp    80102e08 <log_write+0x98>
80102dd0:	39 14 85 ec 27 11 80 	cmp    %edx,-0x7feed814(,%eax,4)
...
80102de0:	89 14 85 ec 27 11 80 	mov    %edx,-0x7feed814(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
80102de7:	83 c0 01             	add    $0x1,%eax
80102dea:	a3 e8 27 11 80       	mov    %eax,0x801127e8
  b->flags |= B_DIRTY; // prevent eviction
80102def:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102df2:	c7 45 08 a0 27 11 80 	movl   $0x801127a0,0x8(%ebp)
}
...
80102e02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102e08:	89 14 85 ec 27 11 80 	mov    %edx,-0x7feed814(,%eax,4)
80102e0f:	eb de                	jmp    80102def <log_write+0x7f>
80102e11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80102e18:	8b 43 08             	mov    0x8(%ebx),%eax
80102e1b:	a3 ec 27 11 80       	mov    %eax,0x801127ec
  if (i == log.lh.n)
...
80102e29:	68 d3 74 10 80       	push   $0x801074d3
80102e2e:	e8 5d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e33:	83 ec 0c             	sub    $0xc,%esp
80102e36:	68 e9 74 10 80       	push   $0x801074e9
...
80102e58:	68 04 75 10 80       	push   $0x80107504
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 95 3a 00 00       	call   80106920 <switchkvm>
  seginit();
80102e8b:	e8 00 3a 00 00       	call   80106890 <seginit>
  lapicinit();
...
80102ec1:	e8 2a 3f 00 00       	call   80106df0 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 bb 39 00 00       	call   80106890 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 77 2c 00 00       	call   80105b60 <uartinit>
  pinit();         // process table
...
80102f19:	69 05 20 2e 11 80 b0 	imul   $0xb0,0x80112e20,%eax
80102f20:	00 00 00 
80102f23:	83 c4 10             	add    $0x10,%esp
80102f26:	05 a0 28 11 80       	add    $0x801128a0,%eax
80102f2b:	3d a0 28 11 80       	cmp    $0x801128a0,%eax
80102f30:	76 71                	jbe    80102fa3 <main+0x103>
80102f32:	bb a0 28 11 80       	mov    $0x801128a0,%ebx
...
80102f88:	74 f6                	je     80102f80 <main+0xe0>
  for(c = cpus; c < cpus+ncpu; c++){
80102f8a:	69 05 20 2e 11 80 b0 	imul   $0xb0,0x80112e20,%eax
80102f91:	00 00 00 
80102f94:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102f9a:	05 a0 28 11 80       	add    $0x801128a0,%eax
...
80102fee:	68 18 75 10 80       	push   $0x80107518
...
801030ac:	68 35 75 10 80       	push   $0x80107535
...
80103117:	a3 9c 27 11 80       	mov    %eax,0x8011279c
...
80103140:	ff 24 95 5c 75 10 80 	jmp    *-0x7fef8aa4(,%edx,4)
...
80103185:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
80103188:	8b 0d 20 2e 11 80    	mov    0x80112e20,%ecx
...
801031a0:	89 0d 20 2e 11 80    	mov    %ecx,0x80112e20
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031a6:	88 97 a0 28 11 80    	mov    %dl,-0x7feed760(%edi)
...
801031bc:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031bf:	88 15 80 28 11 80    	mov    %dl,0x80112880
      continue;
...
801031f3:	68 1d 75 10 80       	push   $0x8010751d
801031f8:	e8 93 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801031fd:	83 ec 0c             	sub    $0xc,%esp
80103200:	68 3c 75 10 80       	push   $0x8010753c
...
801032f8:	00 00 00 
  initlock(&p->lock, "pipe");
801032fb:	68 70 75 10 80       	push   $0x80107570
...
80103604:	bb 74 2e 11 80       	mov    $0x80112e74,%ebx
{
80103609:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010360c:	68 40 2e 11 80       	push   $0x80112e40
...
80103644:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103647:	68 40 2e 11 80       	push   $0x80112e40
  p->pid = nextpid++;
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 a2 57 10 80 	movl   $0x801057a2,0x14(%eax)
  p->context = (struct context*)sp;
...
801036a3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036a5:	68 40 2e 11 80       	push   $0x80112e40
...
801036d3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036d6:	68 40 2e 11 80       	push   $0x80112e40
...
80103726:	68 75 75 10 80       	push   $0x80107575
8010372b:	68 40 2e 11 80       	push   $0x80112e40
...
8010374c:	e8 df ef ff ff       	call   80102730 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103751:	8b 35 20 2e 11 80    	mov    0x80112e20,%esi
80103757:	85 f6                	test   %esi,%esi
80103759:	7e 42                	jle    8010379d <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010375b:	0f b6 15 a0 28 11 80 	movzbl 0x801128a0,%edx
80103762:	39 d0                	cmp    %edx,%eax
80103764:	74 30                	je     80103796 <mycpu+0x56>
80103766:	b9 50 29 11 80       	mov    $0x80112950,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010378a:	05 a0 28 11 80       	add    $0x801128a0,%eax
}
...
801037cb:	2d a0 28 11 80       	sub    $0x801128a0,%eax
}
801037d0:	c9                   	leave  
  return mycpu()-cpus;
...
80103823:	e8 48 35 00 00       	call   80106d70 <setupkvm>
...
80103841:	e8 0a 32 00 00       	call   80106a50 <inituvm>
...
801038f3:	68 8c 75 10 80       	push   $0x8010758c
...
8010392c:	e8 0f 30 00 00       	call   80106940 <switchuvm>
  return 0;
...
8010394a:	e8 41 32 00 00       	call   80106b90 <allocuvm>
...
8010396a:	e8 51 33 00 00       	call   80106cc0 <deallocuvm>
...
801039b8:	e8 83 34 00 00       	call   80106e40 <copyuvm>
...
80103a36:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a39:	c7 04 24 40 2e 11 80 	movl   $0x80112e40,(%esp)
80103a40:	e8 fb 08 00 00       	call   80104340 <acquire>
  np->state = RUNNABLE;
80103a45:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a4c:	c7 04 24 40 2e 11 80 	movl   $0x80112e40,(%esp)
...
80103ac1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ac4:	bb 74 2e 11 80       	mov    $0x80112e74,%ebx
    acquire(&ptable.lock);
80103ac9:	68 40 2e 11 80       	push   $0x80112e40
...
80103af0:	e8 4b 2e 00 00       	call   80106940 <switchuvm>
...
80103b02:	e8 84 0b 00 00       	call   8010468b <swtch>
      switchkvm();
80103b07:	e8 14 2e 00 00       	call   80106920 <switchkvm>
      c->proc = 0;
...
80103b1c:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
80103b22:	72 bc                	jb     80103ae0 <scheduler+0x40>
    release(&ptable.lock);
80103b24:	83 ec 0c             	sub    $0xc,%esp
80103b27:	68 40 2e 11 80       	push   $0x80112e40
...
80103b5d:	68 40 2e 11 80       	push   $0x80112e40
...
80103c64:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103c6b:	c7 04 24 40 2e 11 80 	movl   $0x80112e40,(%esp)
...
80103cd7:	75 e7                	jne    80103cc0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cd9:	b8 74 2e 11 80       	mov    $0x80112e74,%eax
80103cde:	eb 0a                	jmp    80103cea <exit+0xea>
80103ce0:	83 c0 7c             	add    $0x7c,%eax
80103ce3:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
...
80103d0d:	68 fd 75 10 80       	push   $0x801075fd
80103d12:	e8 79 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	68 f0 75 10 80       	push   $0x801075f0
...
80103d37:	68 40 2e 11 80       	push   $0x80112e40
...
80103d5d:	e8 de fd ff ff       	call   80103b40 <sched>
  release(&ptable.lock);
80103d62:	c7 04 24 40 2e 11 80 	movl   $0x80112e40,(%esp)
...
80103db0:	81 fe 40 2e 11 80    	cmp    $0x80112e40,%esi
80103db6:	74 50                	je     80103e08 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103db8:	83 ec 0c             	sub    $0xc,%esp
80103dbb:	68 40 2e 11 80       	push   $0x80112e40
...
80103ddc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103de3:	c7 04 24 40 2e 11 80 	movl   $0x80112e40,(%esp)
...
80103e29:	68 0f 76 10 80       	push   $0x8010760f
80103e2e:	e8 5d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e33:	83 ec 0c             	sub    $0xc,%esp
80103e36:	68 09 76 10 80       	push   $0x80107609
...
80103e91:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e96:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
...
80103eac:	68 40 2e 11 80       	push   $0x80112e40
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 12 2e 00 00       	call   80106cf0 <freevm>
        release(&ptable.lock);
80103ede:	c7 04 24 40 2e 11 80 	movl   $0x80112e40,(%esp)
        p->pid = 0;
...
80103f19:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f1e:	68 40 2e 11 80       	push   $0x80112e40
...
80103f6f:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
80103f74:	72 e4                	jb     80103f5a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103f76:	c7 45 08 40 2e 11 80 	movl   $0x80112e40,0x8(%ebp)
}
...
80103fd6:	68 40 2e 11 80       	push   $0x80112e40
...
80103ff3:	68 40 2e 11 80       	push   $0x80112e40
...
80104016:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104019:	bb 74 2e 11 80       	mov    $0x80112e74,%ebx
{
...
8010404e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104051:	ba 20 76 10 80       	mov    $0x80107620,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104056:	77 11                	ja     80104069 <procdump+0x59>
80104058:	8b 14 85 80 76 10 80 	mov    -0x7fef8980(,%eax,4),%edx
      state = "???";
8010405f:	b8 20 76 10 80       	mov    $0x80107620,%eax
...
80104071:	68 24 76 10 80       	push   $0x80107624
...
801040ad:	68 61 70 10 80       	push   $0x80107061
...
801040da:	68 98 76 10 80       	push   $0x80107698
...
801042f5:	68 a3 76 10 80       	push   $0x801076a3
801042fa:	e8 91 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
801042ff:	83 ec 0c             	sub    $0xc,%esp
80104302:	68 ba 76 10 80       	push   $0x801076ba
...
801043e7:	68 c1 76 10 80       	push   $0x801076c1
...
8010443c:	68 c9 76 10 80       	push   $0x801076c9
...
80104840 <syscall>:
[SYS_getlastcat]  sys_getlastcat,   //2. Add sys_getlastcat to system_call table
};
...
8010485c:	8b 14 85 00 77 10 80 	mov    -0x7fef8900(,%eax,4),%edx
...
80104880:	68 d1 76 10 80       	push   $0x801076d1
...
801049d4:	68 78 77 10 80       	push   $0x80107778
...
801049ec:	68 77 77 10 80       	push   $0x80107777
...
80104a05:	68 6b 77 10 80       	push   $0x8010776b
...
80104a1a:	68 7a 77 10 80       	push   $0x8010777a
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
        panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 5c 77 10 80       	push   $0x8010775c
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 78 77 10 80       	push   $0x80107778
...
80104e34:	68 77 77 10 80       	push   $0x80107777
...
801052b7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    while(*p && *p == *q)
801052ba:	0f b6 02             	movzbl (%edx),%eax
801052bd:	0f b6 19             	movzbl (%ecx),%ebx
801052c0:	84 c0                	test   %al,%al
801052c2:	75 1c                	jne    801052e0 <my_strcmp+0x30>
801052c4:	eb 2a                	jmp    801052f0 <my_strcmp+0x40>
801052c6:	8d 76 00             	lea    0x0(%esi),%esi
801052c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        p++, q++;
801052d0:	83 c2 01             	add    $0x1,%edx
    while(*p && *p == *q)
801052d3:	0f b6 02             	movzbl (%edx),%eax
        p++, q++;
801052d6:	83 c1 01             	add    $0x1,%ecx
801052d9:	0f b6 19             	movzbl (%ecx),%ebx
    while(*p && *p == *q)
801052dc:	84 c0                	test   %al,%al
801052de:	74 10                	je     801052f0 <my_strcmp+0x40>
801052e0:	38 d8                	cmp    %bl,%al
801052e2:	74 ec                	je     801052d0 <my_strcmp+0x20>
    return (uchar)*p - (uchar)*q;
...
{
8010530c:	81 ec b4 00 00 00    	sub    $0xb4,%esp
    if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
...
8010531f:	0f 88 d3 00 00 00    	js     801053f8 <sys_exec+0xf8>
80105325:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
8010532b:	83 ec 08             	sub    $0x8,%esp
8010532e:	50                   	push   %eax
8010532f:	6a 01                	push   $0x1
80105331:	e8 1a f4 ff ff       	call   80104750 <argint>
80105336:	83 c4 10             	add    $0x10,%esp
80105339:	85 c0                	test   %eax,%eax
8010533b:	0f 88 b7 00 00 00    	js     801053f8 <sys_exec+0xf8>
        return -1;
    }

    memset(argv, 0, sizeof(argv));
80105341:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80105347:	83 ec 04             	sub    $0x4,%esp
8010534a:	68 80 00 00 00       	push   $0x80
8010534f:	6a 00                	push   $0x0
80105351:	50                   	push   %eax
80105352:	e8 f9 f0 ff ff       	call   80104450 <memset>

    // Now we have the correct value in path, so we can compare it
    if (my_strcmp(path, "cat") == 0) {
80105357:	8b 9d 5c ff ff ff    	mov    -0xa4(%ebp),%ebx
    while(*p && *p == *q)
8010535d:	83 c4 10             	add    $0x10,%esp
80105360:	80 3b 63             	cmpb   $0x63,(%ebx)
80105363:	75 2f                	jne    80105394 <sys_exec+0x94>
80105365:	b8 01 00 00 00       	mov    $0x1,%eax
8010536a:	eb 0b                	jmp    80105377 <sys_exec+0x77>
8010536c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105370:	83 c0 01             	add    $0x1,%eax
80105373:	38 ca                	cmp    %cl,%dl
80105375:	75 1d                	jne    80105394 <sys_exec+0x94>
80105377:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
8010537b:	0f b6 88 bd 77 10 80 	movzbl -0x7fef8843(%eax),%ecx
80105382:	84 d2                	test   %dl,%dl
80105384:	75 ea                	jne    80105370 <sys_exec+0x70>
    if (my_strcmp(path, "cat") == 0) {
80105386:	84 c9                	test   %cl,%cl
80105388:	75 0a                	jne    80105394 <sys_exec+0x94>
        cat_called = 1; // Set a flag to track cat
8010538a:	c7 05 c0 a6 10 80 01 	movl   $0x1,0x8010a6c0
80105391:	00 00 00 
80105394:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
    while(*p && *p == *q)
8010539a:	c7 85 54 ff ff ff 00 	movl   $0x0,-0xac(%ebp)
801053a1:	00 00 00 
801053a4:	31 db                	xor    %ebx,%ebx
801053a6:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
801053ac:	eb 30                	jmp    801053de <sys_exec+0xde>
...
801053b8:	74 4e                	je     80105408 <sys_exec+0x108>
            argv[i] = 0;
            break;
        }
...
801053bf:	e8 1c f3 ff ff       	call   801046e0 <fetchstr>
801053c4:	83 c4 10             	add    $0x10,%esp
801053c7:	85 c0                	test   %eax,%eax
801053c9:	78 2d                	js     801053f8 <sys_exec+0xf8>
            return -1;
        //cprintf("argv%d: %s", i, argv[i]);
        lastArg = argv[i];
801053cb:	8b 06                	mov    (%esi),%eax
    for(i=0;; i++){
801053cd:	83 c3 01             	add    $0x1,%ebx
801053d0:	83 c6 04             	add    $0x4,%esi
        if(i >= NELEM(argv))
801053d3:	83 fb 20             	cmp    $0x20,%ebx
        lastArg = argv[i];
801053d6:	89 85 54 ff ff ff    	mov    %eax,-0xac(%ebp)
        if(i >= NELEM(argv))
801053dc:	74 1a                	je     801053f8 <sys_exec+0xf8>
        if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801053de:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801053e4:	83 ec 08             	sub    $0x8,%esp
801053e7:	57                   	push   %edi
801053e8:	8d 04 98             	lea    (%eax,%ebx,4),%eax
801053eb:	50                   	push   %eax
801053ec:	e8 af f2 ff ff       	call   801046a0 <fetchint>
801053f1:	83 c4 10             	add    $0x10,%esp
801053f4:	85 c0                	test   %eax,%eax
801053f6:	79 b8                	jns    801053b0 <sys_exec+0xb0>
    }
    if (my_strcmp(path, "cat") == 0) {
        safestrcpy(last_cat_arg, lastArg, sizeof(last_cat_arg));
    }
...
80105405:	8d 76 00             	lea    0x0(%esi),%esi
            argv[i] = 0;
80105408:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
8010540f:	00 00 00 00 
    if (my_strcmp(path, "cat") == 0) {
80105413:	8b 9d 5c ff ff ff    	mov    -0xa4(%ebp),%ebx
    while(*p && *p == *q)
80105419:	80 3b 63             	cmpb   $0x63,(%ebx)
8010541c:	75 45                	jne    80105463 <sys_exec+0x163>
8010541e:	b8 01 00 00 00       	mov    $0x1,%eax
80105423:	eb 0a                	jmp    8010542f <sys_exec+0x12f>
80105425:	8d 76 00             	lea    0x0(%esi),%esi
80105428:	83 c0 01             	add    $0x1,%eax
8010542b:	38 ca                	cmp    %cl,%dl
8010542d:	75 34                	jne    80105463 <sys_exec+0x163>
8010542f:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
80105433:	0f b6 88 bd 77 10 80 	movzbl -0x7fef8843(%eax),%ecx
8010543a:	84 d2                	test   %dl,%dl
8010543c:	75 ea                	jne    80105428 <sys_exec+0x128>
    if (my_strcmp(path, "cat") == 0) {
8010543e:	84 c9                	test   %cl,%cl
80105440:	75 21                	jne    80105463 <sys_exec+0x163>
        safestrcpy(last_cat_arg, lastArg, sizeof(last_cat_arg));
80105442:	83 ec 04             	sub    $0x4,%esp
80105445:	68 00 01 00 00       	push   $0x100
8010544a:	ff b5 54 ff ff ff    	pushl  -0xac(%ebp)
80105450:	68 c0 a5 10 80       	push   $0x8010a5c0
80105455:	e8 d6 f1 ff ff       	call   80104630 <safestrcpy>
8010545a:	8b 9d 5c ff ff ff    	mov    -0xa4(%ebp),%ebx
80105460:	83 c4 10             	add    $0x10,%esp
    return exec(path, argv);
80105463:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80105469:	83 ec 08             	sub    $0x8,%esp
8010546c:	50                   	push   %eax
8010546d:	53                   	push   %ebx
8010546e:	e8 9d b5 ff ff       	call   80100a10 <exec>
...
80105483:	53                   	push   %ebx
    char *buf;
    if (argstr(0, &buf) < 0) // Get the character buffer from user
...
8010548d:	e8 6e f3 ff ff       	call   80104800 <argstr>
80105492:	83 c4 10             	add    $0x10,%esp
80105495:	85 c0                	test   %eax,%eax
80105497:	78 57                	js     801054f0 <sys_getlastcat+0x70>
        return-1;

    //Case3: If a user program calls the system call with a null pointer, it should return -1 to indicate failure.
    if (buf == 0){
80105499:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010549c:	85 c0                	test   %eax,%eax
8010549e:	74 50                	je     801054f0 <sys_getlastcat+0x70>
        return -1;
    }

    //Case1: If cat has never been run, we should copy "Cat has not yet been called" to the character pointer, return 0
    if (!cat_called) {
801054a0:	8b 1d c0 a6 10 80    	mov    0x8010a6c0,%ebx
801054a6:	85 db                	test   %ebx,%ebx
801054a8:	74 26                	je     801054d0 <sys_getlastcat+0x50>
    //Case4: If cat was called with a file that did not exist, the system call should copy Invalid filename to the buffer.
    //Case5: If cat was called with multiple arguments and one of those was non-existent,
    // the system call should still copy "Invalid filename" to the buffer regardless of the position of the non-existent file in the argument list.

    //Base Case: If cat had been called, the last argument should be copied into the buffer, return 0
    safestrcpy(buf, last_cat_arg, sizeof(last_cat_arg));
801054aa:	83 ec 04             	sub    $0x4,%esp
    return 0;
801054ad:	31 db                	xor    %ebx,%ebx
    safestrcpy(buf, last_cat_arg, sizeof(last_cat_arg));
801054af:	68 00 01 00 00       	push   $0x100
801054b4:	68 c0 a5 10 80       	push   $0x8010a5c0
801054b9:	50                   	push   %eax
801054ba:	e8 71 f1 ff ff       	call   80104630 <safestrcpy>
    return 0;
801054bf:	83 c4 10             	add    $0x10,%esp
}
801054c2:	89 d8                	mov    %ebx,%eax
801054c4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801054c7:	c9                   	leave  
801054c8:	c3                   	ret    
801054c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        safestrcpy(buf, "Cat has not yet been called", 256);
801054d0:	83 ec 04             	sub    $0x4,%esp
801054d3:	68 00 01 00 00       	push   $0x100
801054d8:	68 c1 77 10 80       	push   $0x801077c1
801054dd:	50                   	push   %eax
801054de:	e8 4d f1 ff ff       	call   80104630 <safestrcpy>
}
801054e3:	89 d8                	mov    %ebx,%eax
        return 0;
...
801054ed:	8d 76 00             	lea    0x0(%esi),%esi
        return-1;
801054f0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801054f5:	eb cb                	jmp    801054c2 <sys_getlastcat+0x42>
...
80105511:	e8 8a f2 ff ff       	call   801047a0 <argptr>
...
8010553f:	31 db                	xor    %ebx,%ebx
    struct proc *curproc = myproc();
80105541:	e8 9a e2 ff ff       	call   801037e0 <myproc>
...
80105567:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    struct proc *curproc = myproc();
8010556a:	e8 71 e2 ff ff       	call   801037e0 <myproc>
    for(fd = 0; fd < NOFILE; fd++){
...
801055a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            myproc()->ofile[fd0] = 0;
801055a8:	e8 33 e2 ff ff       	call   801037e0 <myproc>
...
801055e3:	5d                   	pop    %ebp
  return fork();
801055e4:	e9 97 e3 ff ff       	jmp    80103980 <fork>
...
801055f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801055f6:	e8 05 e6 ff ff       	call   80103c00 <exit>
...
80105603:	5d                   	pop    %ebp
  return wait();
80105604:	e9 37 e8 ff ff       	jmp    80103e40 <wait>
...
8010561c:	e8 2f f1 ff ff       	call   80104750 <argint>
...
8010562e:	e8 5d e9 ff ff       	call   80103f90 <kill>
...
80105653:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105656:	e8 85 e1 ff ff       	call   801037e0 <myproc>
...
80105686:	e8 75 e2 ff ff       	call   80103900 <growproc>
...
801056bd:	e8 8e f0 ff ff       	call   80104750 <argint>
...
801056d5:	e8 66 ec ff ff       	call   80104340 <acquire>
  ticks0 = ticks;
...
801056fd:	e8 7e e6 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
...
8010570f:	73 2f                	jae    80105740 <sys_sleep+0x90>
    if(myproc()->killed){
80105711:	e8 ca e0 ff ff       	call   801037e0 <myproc>
...
80105725:	e8 d6 ec ff ff       	call   80104400 <release>
      return -1;
...
80105748:	e8 b3 ec ff ff       	call   80104400 <release>
  return 0;
...
801057c7:	c7 04 c5 c2 4d 11 80 	movl   $0x8e000008,-0x7feeb23e(,%eax,8)
801057ce:	08 00 00 8e 
801057d2:	66 89 14 c5 c0 4d 11 	mov    %dx,-0x7feeb240(,%eax,8)
801057d9:	80 
801057da:	c1 ea 10             	shr    $0x10,%edx
801057dd:	66 89 14 c5 c6 4d 11 	mov    %dx,-0x7feeb23a(,%eax,8)
801057e4:	80 
  for(i = 0; i < 256; i++)
...
801057f4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057f7:	c7 05 c2 4f 11 80 08 	movl   $0xef000008,0x80114fc2
801057fe:	00 00 ef 
  initlock(&tickslock, "time");
80105801:	68 dd 77 10 80       	push   $0x801077dd
80105806:	68 80 4d 11 80       	push   $0x80114d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010580b:	66 a3 c0 4f 11 80    	mov    %ax,0x80114fc0
80105811:	c1 e8 10             	shr    $0x10,%eax
80105814:	66 a3 c6 4f 11 80    	mov    %ax,0x80114fc6
  initlock(&tickslock, "time");
8010581a:	e8 e1 e9 ff ff       	call   80104200 <initlock>
}
...
8010583b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010583f:	b8 c0 4d 11 80       	mov    $0x80114dc0,%eax
...
80105872:	0f 84 f0 00 00 00    	je     80105968 <trap+0x108>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105880:	ff 24 85 84 78 10 80 	jmp    *-0x7fef877c(,%eax,4)
...
80105897:	8b 5f 38             	mov    0x38(%edi),%ebx
8010589a:	0f 84 14 02 00 00    	je     80105ab4 <trap+0x254>
801058a0:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801058a4:	0f 84 0a 02 00 00    	je     80105ab4 <trap+0x254>
...
801058b5:	89 45 dc             	mov    %eax,-0x24(%ebp)
801058b8:	8b 47 34             	mov    0x34(%edi),%eax
801058bb:	8b 77 30             	mov    0x30(%edi),%esi
...
801058c9:	e8 12 df ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801058e5:	68 40 78 10 80       	push   $0x80107840
...
801058fe:	e8 dd de ff ff       	call   801037e0 <myproc>
80105903:	85 c0                	test   %eax,%eax
80105905:	74 1d                	je     80105924 <trap+0xc4>
80105907:	e8 d4 de ff ff       	call   801037e0 <myproc>
...
8010591e:	0f 84 4c 01 00 00    	je     80105a70 <trap+0x210>
    exit();
...
8010592d:	e8 ae de ff ff       	call   801037e0 <myproc>
80105932:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105936:	74 68                	je     801059a0 <trap+0x140>
...
8010593f:	74 19                	je     8010595a <trap+0xfa>
80105941:	e8 9a de ff ff       	call   801037e0 <myproc>
80105946:	8b 40 24             	mov    0x24(%eax),%eax
80105949:	85 c0                	test   %eax,%eax
8010594b:	74 0d                	je     8010595a <trap+0xfa>
8010594d:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105951:	83 e0 03             	and    $0x3,%eax
80105954:	66 83 f8 03          	cmp    $0x3,%ax
80105958:	74 37                	je     80105991 <trap+0x131>
    exit();
}
8010595a:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010595d:	5b                   	pop    %ebx
8010595e:	5e                   	pop    %esi
8010595f:	5f                   	pop    %edi
80105960:	5d                   	pop    %ebp
...
8010596d:	8b 58 24             	mov    0x24(%eax),%ebx
80105970:	85 db                	test   %ebx,%ebx
80105972:	0f 85 e8 00 00 00    	jne    80105a60 <trap+0x200>
    myproc()->tf = tf;
80105978:	e8 63 de ff ff       	call   801037e0 <myproc>
8010597d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105980:	e8 bb ee ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
80105985:	e8 56 de ff ff       	call   801037e0 <myproc>
8010598a:	8b 48 24             	mov    0x24(%eax),%ecx
8010598d:	85 c9                	test   %ecx,%ecx
8010598f:	74 c9                	je     8010595a <trap+0xfa>
}
...
80105997:	5d                   	pop    %ebp
      exit();
80105998:	e9 63 e2 ff ff       	jmp    80103c00 <exit>
8010599d:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
801059a0:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
801059a4:	75 92                	jne    80105938 <trap+0xd8>
    yield();
801059a6:	e8 85 e3 ff ff       	call   80103d30 <yield>
801059ab:	eb 8b                	jmp    80105938 <trap+0xd8>
801059ad:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801059b0:	e8 0b de ff ff       	call   801037c0 <cpuid>
801059b5:	85 c0                	test   %eax,%eax
801059b7:	0f 84 c3 00 00 00    	je     80105a80 <trap+0x220>
    lapiceoi();
801059bd:	e8 8e cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059c2:	e8 19 de ff ff       	call   801037e0 <myproc>
801059c7:	85 c0                	test   %eax,%eax
801059c9:	0f 85 38 ff ff ff    	jne    80105907 <trap+0xa7>
801059cf:	e9 50 ff ff ff       	jmp    80105924 <trap+0xc4>
801059d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801059d8:	e8 33 cc ff ff       	call   80102610 <kbdintr>
    lapiceoi();
801059dd:	e8 6e cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059e2:	e8 f9 dd ff ff       	call   801037e0 <myproc>
801059e7:	85 c0                	test   %eax,%eax
801059e9:	0f 85 18 ff ff ff    	jne    80105907 <trap+0xa7>
801059ef:	e9 30 ff ff ff       	jmp    80105924 <trap+0xc4>
801059f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
801059f8:	e8 53 02 00 00       	call   80105c50 <uartintr>
    lapiceoi();
801059fd:	e8 4e cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a02:	e8 d9 dd ff ff       	call   801037e0 <myproc>
80105a07:	85 c0                	test   %eax,%eax
80105a09:	0f 85 f8 fe ff ff    	jne    80105907 <trap+0xa7>
80105a0f:	e9 10 ff ff ff       	jmp    80105924 <trap+0xc4>
80105a14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105a18:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105a1c:	8b 77 38             	mov    0x38(%edi),%esi
80105a1f:	e8 9c dd ff ff       	call   801037c0 <cpuid>
80105a24:	56                   	push   %esi
80105a25:	53                   	push   %ebx
80105a26:	50                   	push   %eax
80105a27:	68 e8 77 10 80       	push   $0x801077e8
80105a2c:	e8 2f ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105a31:	e8 1a cd ff ff       	call   80102750 <lapiceoi>
    break;
80105a36:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a39:	e8 a2 dd ff ff       	call   801037e0 <myproc>
80105a3e:	85 c0                	test   %eax,%eax
80105a40:	0f 85 c1 fe ff ff    	jne    80105907 <trap+0xa7>
80105a46:	e9 d9 fe ff ff       	jmp    80105924 <trap+0xc4>
80105a4b:	90                   	nop
80105a4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105a50:	e8 2b c6 ff ff       	call   80102080 <ideintr>
80105a55:	e9 63 ff ff ff       	jmp    801059bd <trap+0x15d>
80105a5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105a60:	e8 9b e1 ff ff       	call   80103c00 <exit>
80105a65:	e9 0e ff ff ff       	jmp    80105978 <trap+0x118>
80105a6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105a70:	e8 8b e1 ff ff       	call   80103c00 <exit>
80105a75:	e9 aa fe ff ff       	jmp    80105924 <trap+0xc4>
80105a7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105a80:	83 ec 0c             	sub    $0xc,%esp
80105a83:	68 80 4d 11 80       	push   $0x80114d80
80105a88:	e8 b3 e8 ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
80105a8d:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
      ticks++;
80105a94:	83 05 c0 55 11 80 01 	addl   $0x1,0x801155c0
      wakeup(&ticks);
80105a9b:	e8 90 e4 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105aa0:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105aa7:	e8 54 e9 ff ff       	call   80104400 <release>
80105aac:	83 c4 10             	add    $0x10,%esp
80105aaf:	e9 09 ff ff ff       	jmp    801059bd <trap+0x15d>
80105ab4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ab7:	e8 04 dd ff ff       	call   801037c0 <cpuid>
80105abc:	83 ec 0c             	sub    $0xc,%esp
80105abf:	56                   	push   %esi
80105ac0:	53                   	push   %ebx
80105ac1:	50                   	push   %eax
80105ac2:	ff 77 30             	pushl  0x30(%edi)
80105ac5:	68 0c 78 10 80       	push   $0x8010780c
80105aca:	e8 91 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105acf:	83 c4 14             	add    $0x14,%esp
80105ad2:	68 e2 77 10 80       	push   $0x801077e2
...
{
  if(!uart)
80105ae0:	a1 c4 a6 10 80       	mov    0x8010a6c4,%eax
{
...
80105b35:	e8 36 cc ff ff       	call   80102770 <microdelay>
...
80105bb7:	74 5a                	je     80105c13 <uartinit+0xb3>
  uart = 1;
80105bb9:	c7 05 c4 a6 10 80 01 	movl   $0x1,0x8010a6c4
80105bc0:	00 00 00 
...
80105bcc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105bcf:	bb 04 79 10 80       	mov    $0x80107904,%ebx
  ioapicenable(IRQ_COM1, 0);
80105bd4:	6a 00                	push   $0x0
80105bd6:	6a 04                	push   $0x4
80105bd8:	e8 f3 c6 ff ff       	call   801022d0 <ioapicenable>
...
80105bf8:	74 19                	je     80105c13 <uartinit+0xb3>
  if(!uart)
80105bfa:	8b 15 c4 a6 10 80    	mov    0x8010a6c4,%edx
...
80105c20 <uartputc>:
  if(!uart)
80105c20:	8b 15 c4 a6 10 80    	mov    0x8010a6c4,%edx
{
...
80105c5b:	e8 b0 ab ff ff       	call   80100810 <consoleintr>
}
...
{
801066e8:	89 d7                	mov    %edx,%edi
  pde = &pgdir[PDX(va)];
801066ea:	c1 eb 16             	shr    $0x16,%ebx
801066ed:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
801066f0:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
801066f3:	8b 06                	mov    (%esi),%eax
801066f5:	a8 01                	test   $0x1,%al
801066f7:	74 27                	je     80106720 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801066f9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801066fe:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
80106704:	c1 ef 0a             	shr    $0xa,%edi
}
80106707:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
8010670a:	89 fa                	mov    %edi,%edx
...
80106724:	e8 97 bd ff ff       	call   801024c0 <kalloc>
...
8010674b:	89 06                	mov    %eax,(%esi)
8010674d:	eb b5                	jmp    80106704 <walkpgdir+0x24>
8010674f:	90                   	nop
}
...
801067dd:	68 0c 79 10 80       	push   $0x8010790c
...
80106834:	e8 d7 ba ff ff       	call   80102310 <kfree>
      *pte = 0;
...
80106882:	68 86 72 10 80       	push   $0x80107286
80106887:	e8 04 9b ff ff       	call   80100390 <panic>
...
80106893:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106896:	e8 25 cf ff ff       	call   801037c0 <cpuid>
8010689b:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
  pd[0] = size-1;
801068a1:	ba 2f 00 00 00       	mov    $0x2f,%edx
801068a6:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068aa:	c7 80 18 29 11 80 ff 	movl   $0xffff,-0x7feed6e8(%eax)
801068b1:	ff 00 00 
801068b4:	c7 80 1c 29 11 80 00 	movl   $0xcf9a00,-0x7feed6e4(%eax)
801068bb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068be:	c7 80 20 29 11 80 ff 	movl   $0xffff,-0x7feed6e0(%eax)
801068c5:	ff 00 00 
801068c8:	c7 80 24 29 11 80 00 	movl   $0xcf9200,-0x7feed6dc(%eax)
801068cf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068d2:	c7 80 28 29 11 80 ff 	movl   $0xffff,-0x7feed6d8(%eax)
801068d9:	ff 00 00 
801068dc:	c7 80 2c 29 11 80 00 	movl   $0xcffa00,-0x7feed6d4(%eax)
801068e3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068e6:	c7 80 30 29 11 80 ff 	movl   $0xffff,-0x7feed6d0(%eax)
801068ed:	ff 00 00 
801068f0:	c7 80 34 29 11 80 00 	movl   $0xcff200,-0x7feed6cc(%eax)
801068f7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801068fa:	05 10 29 11 80       	add    $0x80112910,%eax
  pd[1] = (uint)p;
801068ff:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106903:	c1 e8 10             	shr    $0x10,%eax
80106906:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
8010690a:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010690d:	0f 01 10             	lgdtl  (%eax)
}
80106910:	c9                   	leave  
80106911:	c3                   	ret    
...
80106964:	0f 84 c2 00 00 00    	je     80106a2c <switchuvm+0xec>
  pushcli();
8010696a:	e8 01 d9 ff ff       	call   80104270 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010696f:	e8 cc cd ff ff       	call   80103740 <mycpu>
80106974:	89 c6                	mov    %eax,%esi
80106976:	e8 c5 cd ff ff       	call   80103740 <mycpu>
8010697b:	89 c7                	mov    %eax,%edi
8010697d:	e8 be cd ff ff       	call   80103740 <mycpu>
80106982:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106985:	83 c7 08             	add    $0x8,%edi
80106988:	e8 b3 cd ff ff       	call   80103740 <mycpu>
...
8010699b:	66 89 96 98 00 00 00 	mov    %dx,0x98(%esi)
801069a2:	66 89 be 9a 00 00 00 	mov    %di,0x9a(%esi)
801069a9:	88 86 9f 00 00 00    	mov    %al,0x9f(%esi)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801069af:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069b4:	83 c1 08             	add    $0x8,%ecx
801069b7:	c1 e9 10             	shr    $0x10,%ecx
...
801069d1:	e8 6a cd ff ff       	call   80103740 <mycpu>
...
801069e9:	e8 52 cd ff ff       	call   80103740 <mycpu>
801069ee:	81 c6 00 10 00 00    	add    $0x1000,%esi
801069f4:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801069f7:	e8 44 cd ff ff       	call   80103740 <mycpu>
...
80106a6b:	77 49                	ja     80106ab6 <inituvm+0x66>
  mem = kalloc();
80106a6d:	e8 4e ba ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106a7f:	e8 cc d9 ff ff       	call   80104450 <memset>
...
80106ab0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ab1:	e9 4a da ff ff       	jmp    80104500 <memmove>
    panic("inituvm: more than a page");
80106ab6:	83 ec 0c             	sub    $0xc,%esp
80106ab9:	68 51 79 10 80       	push   $0x80107951
...
80106b13:	e8 c8 fb ff ff       	call   801066e0 <walkpgdir>
...
80106b41:	e8 1a ae ff ff       	call   80101960 <readi>
80106b46:	83 c4 10             	add    $0x10,%esp
80106b49:	39 f8                	cmp    %edi,%eax
...
80106b9e:	0f 88 8e 00 00 00    	js     80106c32 <allocuvm+0xa2>
  if(newsz < oldsz)
...
80106bdb:	e8 70 d8 ff ff       	call   80104450 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106be0:	58                   	pop    %eax
80106be1:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106be7:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106bec:	5a                   	pop    %edx
80106bed:	6a 06                	push   $0x6
...
80106bfe:	78 50                	js     80106c50 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
...
80106c09:	0f 86 81 00 00 00    	jbe    80106c90 <allocuvm+0x100>
    mem = kalloc();
80106c0f:	e8 ac b8 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106c1d:	68 89 79 10 80       	push   $0x80107989
80106c22:	e8 39 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106c27:	83 c4 10             	add    $0x10,%esp
80106c2a:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c2d:	39 45 10             	cmp    %eax,0x10(%ebp)
80106c30:	77 6e                	ja     80106ca0 <allocuvm+0x110>
}
80106c32:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106c35:	31 ff                	xor    %edi,%edi
}
...
80106c53:	68 a1 79 10 80       	push   $0x801079a1
...
80106c66:	76 0d                	jbe    80106c75 <allocuvm+0xe5>
...
80106c7b:	e8 90 b6 ff ff       	call   80102310 <kfree>
      return 0;
...
80106ca0:	89 c1                	mov    %eax,%ecx
80106ca2:	8b 55 10             	mov    0x10(%ebp),%edx
80106ca5:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
80106ca8:	31 ff                	xor    %edi,%edi
80106caa:	e8 41 fb ff ff       	call   801067f0 <deallocuvm.part.0>
80106caf:	eb 92                	jmp    80106c43 <allocuvm+0xb3>
80106cb1:	eb 0d                	jmp    80106cc0 <deallocuvm>
80106cb3:	90                   	nop
80106cb4:	90                   	nop
80106cb5:	90                   	nop
80106cb6:	90                   	nop
...
80106d09:	e8 e2 fa ff ff       	call   801067f0 <deallocuvm.part.0>
...
80106d3e:	e8 cd b5 ff ff       	call   80102310 <kfree>
...
80106d53:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106d54:	e9 b7 b5 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106d59:	83 ec 0c             	sub    $0xc,%esp
80106d5c:	68 bd 79 10 80       	push   $0x801079bd
...
80106d75:	e8 46 b7 ff ff       	call   801024c0 <kalloc>
...
80106d90:	e8 bb d6 ff ff       	call   80104450 <memset>
...
80106dfb:	a3 c4 55 11 80       	mov    %eax,0x801155c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e2f:	68 ce 79 10 80       	push   $0x801079ce
...
80106e80:	e8 7b d6 ff ff       	call   80104500 <memmove>
...
80106ed5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106ed8:	e8 e3 b5 ff ff       	call   801024c0 <kalloc>
...
80106ef1:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
80106f60:	c3                   	ret    
80106f61:	eb 0d                	jmp    80106f70 <copyout>
80106f63:	90                   	nop
80106f64:	90                   	nop
80106f65:	90                   	nop
80106f66:	90                   	nop
...
80106faf:	e8 4c d5 ff ff       	call   80104500 <memmove>
    len -= n;
    buf += n;
